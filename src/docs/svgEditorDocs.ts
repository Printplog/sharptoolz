...
export const svgEditorDocs: DocSection[] = [
  ...
  {
    id: "barcode-fields",
    title: "Barcode Extensions",
    content: "Generate scannable barcodes from SVG image elements. Uses a single carrier like QR: .barcode_(symbology) where the symbology is the barcode type, optionally followed by a content rule. Pick the symbology from the dropdown in the editor (defaults to Code 128). Supports linear codes (Code 128/39, EAN, UPC, ITF, Codabar), GS1 DataBar, postal codes, and 2D codes (Data Matrix, Aztec, PDF417, MaxiCode, QR).",
    codeExamples: [
      {
        title: "Static Barcode",
        code: "Tracking.barcode_(code128)",
        description: "A Code 128 barcode where the user types the value to encode. Bare .barcode also works and defaults to Code 128."
      },
      {
        title: "Choose a Symbology",
        code: "Product.barcode_(ean13)",
        description: "An EAN-13 barcode. Pick any symbology from the editor dropdown (grouped Linear / EAN-UPC / GS1 DataBar / Postal / 2D); it's stored as the bcid in parentheses."
      },
      {
        title: "Dynamic Barcode Rule",
        code: "Order.barcode_(code128)(dep_Order_ID)",
        description: "Generates a Code 128 barcode from the Order ID field. The content rule uses the same tokens as gen/QR rules: (dep_Field), (rn[12]), dates, etc."
      },
      {
        title: "Multi-line (2D codes)",
        code: "Boarding.barcode_(pdf417)Name:_(dep_Passenger_Name)\\nFlight:_(dep_Flight_No)",
        description: "PDF417 (or Data Matrix / Aztec) encoding multiple lines. Add rows in the Barcode Builder — each becomes a new line. Use underscores (_) for spaces and \\n between lines."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    codeExamples: [
      ...
      {
        title: "Automatic Generation (AUTO:)",
        code: "Tracking_ID.gen_AUTO:(rn[12])",
        description: "Adding the AUTO: prefix to a rule ensures the value is generated automatically when the document is created or previewed, without requiring user input."
      }
    ],
    subsections: [
      {
        id: "qr-builder-ui",
        title: "Using the QR Builder",
        content: "The QR Builder provides a visual interface for creating structured QR codes. You can add labeled rows (e.g., 'Name: (dep_Name)') and reorder them. The builder handles space encoding (underscores) automatically.",
        codeExamples: [
          {
            title: "Builder Output",
            code: "Flight_QR.qrcode_Name:_(dep_Passenger_Name)\\nSeat:_(dep_Seat)",
            description: "Example of a pattern generated by the QR Builder. Note the \\\\n for line breaks and underscores for spaces."
          }
        ]
      },
      {
        id: "barcode-builder-ui",
        title: "Using the Barcode Builder",
        content: "The Barcode Builder works just like the QR Builder — add labeled rows and each becomes a new line in the barcode (ideal for 2D codes like PDF417 or Data Matrix). Pick the symbology from the two-step dropdown (category, then specific code); it's stored as (bcid) at the start of the carrier. The live preview shows the actual barcode as you build. The user can also add their own custom lines when filling the form.",
        codeExamples: [
          {
            title: "Builder Output",
            code: "Boarding.barcode_(pdf417)Name:_(dep_Passenger_Name)\\nFlight:_(dep_Flight_No)",
            description: "A PDF417 barcode with the symbology in parentheses followed by labeled rows. Note the \\\\n for line breaks and underscores for spaces."
          }
        ]
      },
      {
