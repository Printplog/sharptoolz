    ...
    subsections: [
      ...
      },
      {
        ...
        codeExamples: [
          ...
          { title: "Flight Leg 1 - Origin City", code: "Departure1.text.track_origin1", description: "Departure city for the first leg" },
          { title: "Flight Leg 1 - Dep Date", code: "DepDate1.date.track_origin1_departure_date", description: "Date the flight leaves the origin city" },
          { title: "Flight Leg 1 - Dep Time", code: "DepTime1.text.track_origin1_departure_time", description: "Time the flight leaves the origin city" },
          { title: "Flight Leg 1 - Destination City", code: "Arrival1.text.track_destination1", description: "Arrival city for the first leg" },
          { title: "Flight Leg 1 - Arr Date", code: "ArrDate1.date.track_destination1_arrival_date", description: "Date the flight arrives at the destination city" },
          { title: "Flight Leg 1 - Arr Time", code: "ArrTime1.text.track_destination1_arrival_time", description: "Time the flight arrives at the destination city" },
          { title: "Flight Leg 2 - Origin City", code: "Departure2.text.track_origin2", description: "Departure city for second leg (e.g. for Return or Stop Over flights)" },
          { title: "Flight Leg 2 - Dep Date", code: "DepDate2.date.track_origin2_departure_date", description: "Departure date for the second flight leg" },
          { title: "Flight Leg 2 - Dep Time", code: "DepTime2.text.track_origin2_departure_time", description: "Departure time for the second flight leg" },
          { title: "Flight Leg 2 - Destination City", code: "Arrival2.text.track_destination2", description: "Arrival city for second leg" },
          { title: "Flight Leg 2 - Arr Date", code: "ArrDate2.date.track_destination2_arrival_date", description: "Arrival date for the second flight leg" },
          { title: "Flight Leg 2 - Arr Time", code: "ArrTime2.text.track_destination2_arrival_time", description: "Arrival time for the second flight leg" },
