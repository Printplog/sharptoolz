...
import { Download, ArrowUpRight, ArrowDownRight, Activity, Calendar as CalendarIcon, Clock, DollarSign, X } from 'lucide-react';
                  ...
                  <Calendar
                    ...
                    onSelect={(d) => {
                      if (d) {
                        ...
                        setDate(prev => prev === formatted ? "" : formatted);
                      } else {
                        setDate("");
                      }
                      setDays(null);
