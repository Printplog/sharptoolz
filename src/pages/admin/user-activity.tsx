    ...
    <div className="dashboard-content space-y-8 pb-24">
      ...
      <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[11px] text-zinc-500 hidden sm:inline">Activity Date:</span>
            <Popover>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between px-2">
            <h3 className="text-xs font-bold text-white/40 italic flex items-center gap-2">
        ...
        <div className={cn(
                        ...
                        <div className="flex items-center gap-1.5 shrink-0 ml-2">
                            {isOnline ? (
                                ...
                                <div className="flex items-center gap-1 opacity-40 whitespace-nowrap">
                                    ...
                                    <span className="text-[10px] font-semibold text-white/40">Recent</span>
                                </div>
                            )}
                        </div>
                    </div>
                    <div className="flex items-center justify-between mt-0.5">
                        <p className="text-[11px] font-mono text-white/20 truncate leading-none">
                            {session.ip_address}
                        </p>
                        <div className={cn(
                            "px-1 py-0.5 rounded text-[10px] font-semibold tracking-tighter border leading-none whitespace-nowrap shrink-0",
                            isError 
            ...
            <div className="mt-6 pt-4 border-t border-white/5 space-y-3">
                <div className="flex items-center gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                        <p className="text-[11px] font-bold text-white/20">Active On</p>
                        <p className={cn(
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                        <p className="text-[11px] font-bold text-white/20">Discovery Source</p>
