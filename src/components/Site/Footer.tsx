          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                { key: 'instagram_link', color: "#E1306C", icon: <Instagram className="w-5 h-5" />, label: "Instagram" },
                { key: 'telegram_link', color: "#0088cc", icon: <Send className="w-5 h-5" />, label: "Telegram" },
                { key: 'whatsapp_community_link', color: "#25D366", icon: <MessageCircle className="w-5 h-5" />, label: "WhatsApp" },
                {
                  key: 'tiktok_link',
                  color: "#00f2ea",
                  icon: (
