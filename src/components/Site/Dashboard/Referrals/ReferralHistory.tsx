  ...
  return (
    <div className="rounded-3xl border border-white/10 bg-[#0a0a0a] overflow-hidden">
      <div className="p-6 border-b border-white/5 flex items-center justify-between bg-white/[0.01]">
        ...
        <span className="text-[11px] font-bold text-white/20 bg-white/5 px-3 py-1 rounded-full">
          Recent Activities
        </span>
      </div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left">
          <thead>
            <tr className="text-[11px] font-semibold text-white/30 bg-white/[0.02]">
                ...
                <tr key={ref.id} className="group hover:bg-white/[0.02] transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-semibold italic tracking-tight text-white group-hover:text-primary transition-colors">
                  ...
                  <td className="px-6 py-4">
                    {ref.is_rewarded ? (
                      ...
                      <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/5 text-white/40 text-[11px] font-semibold">
