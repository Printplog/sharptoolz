          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              {isLoading ? (
                ...
                <h3 className="text-3xl font-black tracking-tighter italic text-white uppercase leading-none">
                  {card.value}
                </h3>
              )}
            </div>
            <div className={`p-3 rounded-2xl bg-black/40 border border-white/5 ${card.accent}`}>
