...
export default function Overview({ data }: OverviewProps) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      {/* Total Documents */}
      <Card className="bg-primary/5 border border-primary/10 backdrop-blur-sm">
      ...
      {/* Wallet Balance */}
      <Card className="bg-green-500/5 border border-green-500/10 backdrop-blur-sm">
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <CardTitle className="text-sm font-medium">
            Wallet Balance
          </CardTitle>
      ...
      {/* Active Users */}
      <Card className="bg-blue-500/5 border border-blue-500/10 backdrop-blur-sm">
        <CardHeader className="flex flex-row items-center justify-between pb-2">
      ...
      {/* Downloads */}
      <Card className="bg-purple-500/5 border border-purple-500/10 backdrop-blur-sm">
        <CardHeader className="flex flex-row items-center justify-between pb-2">
