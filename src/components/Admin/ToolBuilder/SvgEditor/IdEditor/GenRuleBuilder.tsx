                  ...
                  <div className="flex-1 min-w-0">
                    {part.type === 'static' && (
                      <input
                        ...
                        className="w-full px-2 py-1 rounded border border-white/20 bg-white/10 text-white text-sm placeholder:text-white/40 focus:outline-none focus:ring-1 focus:ring-white/20"
                      />
                    )}
                    ...
                    {part.type === 'dep' && (
                      <div className="flex gap-1">
                        ...
                        <input
                          ...
                          className="w-20 px-2 py-1 rounded border border-white/20 bg-white/10 text-white text-xs placeholder:text-white/40 focus:outline-none focus:ring-1 focus:ring-white/20"
                        />
                      </div>
                    )}
                      ...
                      <div className="flex flex-col gap-1">
                        <div className="flex gap-1">
                          ...
                          {(part.randomType === 'letter' || part.randomType === 'both') && (
                            ...
                            >
                              <SelectTrigger className="w-24 h-8 text-xs bg-white/10 border-white/20 text-white">
                                <SelectValue />
                              </SelectTrigger>
                              <SelectContent className="bg-black/95 border-white/20 z-[101]">
                    ...
                    {part.type === 'repeat' && (
                      <div className="flex gap-1 min-w-0">
                        <input
                          ...
                          className="w-24 px-2 py-1 rounded border border-white/20 bg-white/10 text-white text-sm placeholder:text-white/40 focus:outline-none focus:ring-1 focus:ring-white/20 shrink-0"
                        />
                        <input
                          type="text"
                          value={countInputs[index] !== undefined ? countInputs[index] : part.count.toString()}
                          ...
                          placeholder="Count"
                          className="flex-1 min-w-0 px-2 py-1 rounded border border-white/20 bg-white/10 text-white text-sm placeholder:text-white/40 focus:outline-none focus:ring-1 focus:ring-white/20"
                        />
                      </div>
                    )}
                    ...
                    {part.type === 'fill' && (
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="flex-1 px-2 py-1 rounded border border-white/20 bg-white/10 text-white text-sm placeholder:text-white/40 focus:outline-none focus:ring-1 focus:ring-white/20"
                        />
