      ...
      return (
        <div className="min-h-screen bg-[#0A0A0B] flex items-center justify-center p-6 font-sans">
          ...
          >
            <div className="bg-white/[0.03] border border-white/10 backdrop-blur-2xl rounded-[2.5rem] p-10 shadow-2xl space-y-8">
              <div className="flex flex-col items-center text-center gap-4">
                ...
                <div className="space-y-2">
                  <h1 className="text-xl font-bold text-white tracking-tight italic italic-primary">
              ...
              {isLocal && (
                <div className="w-full bg-black/20 rounded-2xl p-5 border border-white/5">
                  <p className="text-[11px] font-semibold text-red-400 mb-2 opacity-60">
              ...
              <div className="flex flex-col gap-3">
                ...
                >
                  ...
                  <span className="text-[11px]">Restart Interface</span>
                </button>
                
                <button
                  onClick={this.handleGoHome}
                  className="flex items-center justify-center gap-2 text-white/20 hover:text-white transition-all text-[11px] font-bold"
                >
                  <Home size={12} />
            ...
            <p className="mt-8 text-[11px] text-white/5 text-center font-semibold italic">
