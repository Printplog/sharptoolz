...
export default function DashboardToolCard({ template }: Props) {
    ...
    return (
        <motion.div
            ...
            whileHover={{ y: -5 }}
            className="relative h-[420px] rounded-3xl overflow-hidden border border-white/10 bg-white/[0.02] backdrop-blur-2xl p-6 transition-all duration-500 hover:border-white/20 group/card"
        >
            {/* Background Glow */}
