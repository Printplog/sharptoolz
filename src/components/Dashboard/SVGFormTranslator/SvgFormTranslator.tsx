...
export default function SvgFormTranslator({ isPurchased }: Props) {
  ...
  useEffect(() => {
    ...
    // Generate AUTO fields before processing SVG
    const fieldsWithAutoGenerated = generateAutoFields(fieldsToUse);
  ...
  useEffect(() => {
    ...
    debounceTimeoutRef.current = setTimeout(() => {
      ...
      rafRef.current = requestAnimationFrame(() => {
        try {
          // Generate AUTO fields before updating preview
          const fieldsWithAutoGenerated = generateAutoFields(fields);
        ...
        onValueChange={(value) => {
          ...
          if (value === "preview") {
            ...
            if (baseSvgRef.current && fields.length > 0) {
              // Generate AUTO fields before preview
              const fieldsWithAutoGenerated = generateAutoFields(fields);
